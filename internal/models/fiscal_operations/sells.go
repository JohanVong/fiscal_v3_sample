...
func (self SellReqest) Valid() (err error) {
...
func (self SellReqest) Create() (doc models.Document, positions []models.Position, err error) {
	var (
		pos     models.Position
	...
	doc.IdTypedocument = OPERATION_SALE
